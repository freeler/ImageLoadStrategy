...
//
//import com.example.yuxiaor.service.imageload.IImageLoaderStrategy;
//import com.example.yuxiaor.service.imageload.ImageLoaderOptions;
//
...
//    }
//
//    private void showImageDrawee(ImageLoaderOptions options) {
//        View view = options.getViewContainer();
...
//                imageRequestBuilder.setPostprocessor(new imageload.frescoloader.BlurPostprocessor(view.getContext().getApplicationContext(), 15));
//            }
...
//                // 保证缓存达到一定条件就及时清除缓存
//                .setBitmapMemoryCacheParamsSupplier(new imageload.frescoloader.BitmapMemoryCacheParamsSupplier((ActivityManager) context.getSystemService(Context.ACTIVITY_SERVICE)))
//                .build();
//    }
//
//}
