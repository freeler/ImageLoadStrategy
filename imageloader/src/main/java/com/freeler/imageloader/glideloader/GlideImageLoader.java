package com.freeler.imageloader.glideloader;
...
import com.freeler.imageloader.BitmapUtils;
import com.freeler.imageloader.IImageLoaderStrategy;
import com.freeler.imageloader.ImageLoaderOptions;
...
public class GlideImageLoader implements IImageLoaderStrategy {
    ...
    private GenericRequestBuilder loadGenericParams(GenericRequestBuilder mGenericRequestBuilder, final ImageLoaderOptions options) {
        ...
        if (options.getImageSize() != null) {
            ...
            Log.i("imageloader ", "load params " + options.getImageSize().getWidth() + "  : " + options.getImageSize().getHeight());
